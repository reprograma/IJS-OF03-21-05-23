...
//Testes com o pacote intermediario:
describe('Valor do projeto', () => {
    ...
    test('Retornar um erro ao calcular o valor total do projeto, pois o valor total esperado é 4915 e o codigo estar testando como se o resultado fosse 5120', () => {
        const funcionalidades = [
            'formulario',
            'responsividade',
            'otimizacao_seo',
